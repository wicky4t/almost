...
const testimonialBadges: TestimonialBadge[] = [
  ...
  { image: "/badges/5.png", position: { top: "50%", left: "20%" }, delay: 2.1, shineDelay: 4.9, shineDuration: 16, scale: 1.6 },
  ...
  <div className="relative"> 
    ...
    > 
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/0 via-transparent to-transparent" />
        ...
        >
          <div  
            className="text-[4rem] md:text-[10rem] lg:text-[20rem] font-bosenAlt text-white/70 select-none leading-none opacity-0 animate-fade-in-delayed"
            style={{
              animationDelay: '0.1s',  
              animationFillMode: 'forwards',
